...
PROGRESSION_MODEL_PATH = (
    BASE_DIR / "models/progression_model.pth"
)
...
DISEASE_MODEL_PATH = (
    BASE_DIR / "models/disease_model.pth"
)

PROGRESSION_DATA_PATH = BASE_DIR / "data/progression_df.csv"
IMAGE_MANIFEST_PATH = BASE_DIR / "data/image_manifest.csv"
...
R2_CACHE_DIR = Path(tempfile.gettempdir()) / "crop_disease_r2_cache"
...
class MLInferenceService:
    ...
    def _get_image_path(
        ...
        object_key = f"{leaf_uid}/{image_filename}"

        cache_path = R2_CACHE_DIR / leaf_uid / image_filename
